...
//            log.error("字符不能转成汉语拼音,传入的参数chineseLanguage:{}",chineseLanguage);
        }
        return hanyupinyin;
    }
...
//            logger.error("字符不能转成汉语拼音,传入的参数chineseLanguage:{}",chineseLanguage);
        }
        return hanyupinyin;
    }
...
//                    logger.error("字符不能转成汉语拼音,传入的参数chineseLanguage:{}",chinese);
                }
            } else {
                pybf.append(arr[i]);
            }
